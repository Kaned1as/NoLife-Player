...
public class TagEditActivity extends Activity implements View.OnClickListener, View.OnKeyListener {
	...
	public void onCreate(Bundle state)
	{
		...
		TitleEdit.setOnKeyListener(this);
		ArtistEdit.setOnKeyListener(this);
		AlbumEdit.setOnKeyListener(this);
		LyricsEdit.setOnKeyListener(this);
